...
from curriculum_cli_enhanced import CurriculumCLI, Database
...
def test_continue_flow():
    ...
    try:
        ...
        with patch('curriculum_cli_enhanced.Prompt.ask') as mock_prompt, \
             patch('curriculum_cli_enhanced.Confirm.ask') as mock_confirm, \
             patch('curriculum_cli_enhanced.input') as mock_input, \
             patch('curriculum_cli_enhanced.IntPrompt.ask') as mock_int:
